...
Most CortexIDE AI code lives in the folder `src/vs/workbench/contrib/cortexide/`.



## Editing CortexIDE Code

If you're making changes to CortexIDE as a contributor, you'll want to run a local version to make sure your changes worked. Developer mode lets you do this. Here's how to use it.
...
Here's how to start changing CortexIDE. These steps cover everything from cloning the repo, to opening a Developer Mode window where you can play around with your updates.

1. Clone this repository.
2. `npm install` to install all dependencies.
3. Open CortexIDE or VSCode, and initialize Developer Mode (this can take ~5 min to finish, it's done when 2 of the 3 spinners turn to check marks):
   - Windows: Press <kbd>Ctrl+Shift+B</kbd>.
   - Mac: Press <kbd>Cmd+Shift+B</kbd>.
   - Linux: Press <kbd>Ctrl+Shift+B</kbd>.
4. Open the CortexIDE Developer Mode window:
   - Windows: `./scripts/code.bat`.
   - Mac: `./scripts/code.sh`.
   - Linux: `./scripts/code.sh`.
5. You're good to start editing CortexIDE!
...
- Make sure the path to your CortexIDE folder does not have any spaces in it.
...
- If you have any other questions, feel free to submit an issue in this repository. You can also refer to VSCode's complete [How to Contribute](https://github.com/microsoft/vscode/wiki/How-to-Contribute) page.



#### Building from Terminal

To build CortexIDE from the terminal instead of from inside VSCode, follow the steps above, but instead of pressing <kbd>Cmd+Shift+B</kbd>, run `npm run watch`. The build is done when you see something like this:
...
### Distributing
We distribute CortexIDE via releases. Our build pipeline is based on VSCodium and GitHub Actions to build downloadables.
...
We don't usually recommend building a local executable of CortexIDE—Developer Mode is faster. If you're certain, see details below.

<details>
	<summary> Building Locally (not recommended)</summary>
If you're certain you want to build a local executable of CortexIDE, follow these steps. It can take ~25 minutes.
