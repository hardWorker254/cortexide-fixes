...
import { CORTEXIDE_ACCEPT_DIFF_ACTION_ID, CORTEXIDE_REJECT_DIFF_ACTION_ID, CORTEXIDE_GOTO_NEXT_DIFF_ACTION_ID, CORTEXIDE_GOTO_PREV_DIFF_ACTION_ID, CORTEXIDE_GOTO_NEXT_URI_ACTION_ID, CORTEXIDE_GOTO_PREV_URI_ACTION_ID, CORTEXIDE_ACCEPT_FILE_ACTION_ID, CORTEXIDE_REJECT_FILE_ACTION_ID, CORTEXIDE_ACCEPT_ALL_DIFFS_ACTION_ID, CORTEXIDE_REJECT_ALL_DIFFS_ACTION_ID } from './actionIDs.js';
...
export interface ICortexideCommandBarService {
...
export const ICortexideCommandBarService = createDecorator<ICortexideCommandBarService>('CortexideCommandBarService');
...
export class CortexideCommandBarService extends Disposable implements ICortexideCommandBarService {
	_serviceBrand: undefined;

	static readonly ID: 'void.CortexideCommandBarService'
	...
	async goToURIIdx(idx: number | null): Promise<void> {
		...
		const { model } = await this._cortexideModelService.getModelSafe(nextURI);
		if (!model) return;
...
registerSingleton(ICortexideCommandBarService, CortexideCommandBarService, InstantiationType.Delayed); // delayed is needed here :(


export type CortexideCommandBarProps = {
	uri: URI | null;
	editor: ICodeEditor;
}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_ACCEPT_DIFF_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_REJECT_DIFF_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_GOTO_NEXT_URI_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_GOTO_PREV_URI_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_ACCEPT_FILE_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_REJECT_FILE_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_ACCEPT_ALL_DIFFS_ACTION_ID,
			f1: true,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CORTEXIDE_REJECT_ALL_DIFFS_ACTION_ID,
			f1: true,
