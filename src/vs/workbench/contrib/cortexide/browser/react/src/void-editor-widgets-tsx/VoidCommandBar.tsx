...
import {
	CORTEXIDE_GOTO_NEXT_DIFF_ACTION_ID,
	CORTEXIDE_GOTO_PREV_DIFF_ACTION_ID,
	CORTEXIDE_GOTO_NEXT_URI_ACTION_ID,
	CORTEXIDE_GOTO_PREV_URI_ACTION_ID,
	CORTEXIDE_ACCEPT_FILE_ACTION_ID,
	CORTEXIDE_REJECT_FILE_ACTION_ID,
	CORTEXIDE_ACCEPT_ALL_DIFFS_ACTION_ID,
	CORTEXIDE_REJECT_ALL_DIFFS_ACTION_ID
} from '../../../actionIDs.js';

export const VoidCommandBarMain = ({ uri, editor }: CortexideCommandBarProps) => {
...
export const VoidCommandBar = ({ uri, editor }: CortexideCommandBarProps) => {
	...
	const cortexideModelService = accessor.get('ICortexideModelService')
