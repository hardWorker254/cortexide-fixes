...
const container = viewContainerRegistry.registerViewContainer({
	id: CORTEXIDE_VIEW_CONTAINER_ID,
	title: nls.localize2('voidContainer', 'Chat'), // Chat container (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [CORTEXIDE_VIEW_CONTAINER_ID, {
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupCortexideSidebar';
	constructor(
